...
const Work = () => {
  ...
  const handleWorkFilter = (item) => {
    ...
    setTimeout(() => {
      //setTimeout is an inbuilt function in react
  ...
  return (
    <>
      <h2 className="head-text">
        Welcome <span style={{ color: '#03C03C' }}> To My Projects!</span>
      </h2>

      <div className="app__work-filter">
        {['Nextjs', 'Web App', 'Mobile App', 'React JS', 'All'].map((item, index) => (
          <div
            key={index}
          ...
          <div className="app__work-item app__flex" key={index}>
            <div className="app__work-img app__flex">
              ...
              <motion.div
                ...
                transition={{ duration: 0.25, ease: 'ease', staggerChildren: 0.5 }}
